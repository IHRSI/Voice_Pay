          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600 leading-relaxed">
              ...
              <p className="text-lg mb-6">
                When we met Rohit, a visually impaired teacher who had to rely on others for simple transactions, we knew we had to act. His story, along with countless others, inspired us to create a payment platform that truly works for everyone.
              </p>
              <p className="text-lg">
                Today, VoicePay serves thousands of users across India, from rural farmers making their first digital payment to specially able people who are now empowered with digital payments
              </p>
            </div>
          </div>
        </div>
